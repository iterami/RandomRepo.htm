...
function random_game(){
    const repositories = [
      ...
      '../Platform-2D.htm/index.htm',
      '../Race-2D.htm/index.htm',
      '../RockPaperScissors.htm/index.htm',
      '../RPG-Above.htm/index.htm',
      '../RPG-Side.htm/index.htm',
      '../RTS-2D.htm/index.htm',
      '../Shooter-2D.htm/index.htm',
      '../Slots.htm/index.htm',
